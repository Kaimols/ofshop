...
<input name='token' id='token' value='ad54885c461376896bf1124d378fd523f85693cab4d007044aa4c987387ab9d4' type='hidden'>
<!-- Google Fonts -->
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
...
.gallery-hero {
    position: relative;
    overflow: hidden;
    background: linear-gradient(135deg, rgba(230, 56, 181, 0.08) 0%, rgba(99, 102, 241, 0.05) 50%, transparent 100%);
    border-bottom: 1px solid rgba(255, 255, 255, 0.05);
}
...
.gallery-hero::before {
    ...
    right: 0;
    bottom: 0;
    background: radial-gradient(ellipse at 50% 0%, rgba(230, 56, 181, 0.15) 0%, transparent 60%);
    pointer-events: none;
}
...
.hero-thumbnail::before {
    ...
    position: absolute;
    inset: -4px;
    background: linear-gradient(135deg, #E638B5, #6366f1);
...
.stat-card:hover {
    ...
    border-color: rgba(230, 56, 181, 0.2);
    transform: translateY(-2px);
}

/* Filter Pills - Horizontal Scroll auf Mobile */
.filter-scroll {
...
.filter-pill.active {
    background: linear-gradient(135deg, rgba(230, 56, 181, 0.2) 0%, rgba(99, 102, 241, 0.15) 100%);
    border-color: rgba(230, 56, 181, 0.4);
    color: #fff;
    box-shadow: 0 0 20px rgba(230, 56, 181, 0.2);
}
...
.media-card img.loaded ~ .skeleton {
    opacity: 0;
    pointer-events: none;
}
...
.media-card:hover {
    ...
    box-shadow: 0 10px 40px rgba(230, 56, 181, 0.15);
    z-index: 10;
}

.media-card:hover img.loaded {
    transform: scale(1.1);
}
...
.play-button {
    ...
    width: 50px;
    height: 50px;
    background: rgba(230, 56, 181, 0.9);
    border-radius: 50%;
    display: flex;
    align-items: center;
    justify-content: center;
    box-shadow: 0 0 30px rgba(230, 56, 181, 0.5);
    transition: all 0.3s ease;
}

.media-card:hover .play-button {
    transform: translate(-50%, -50%) scale(1.1);
    box-shadow: 0 0 40px rgba(230, 56, 181, 0.7);
}
...
.action-btn-modern.primary:hover {
    background: linear-gradient(135deg, rgba(230, 56, 181, 0.3) 0%, rgba(99, 102, 241, 0.25) 100%);
    box-shadow: 0 5px 30px rgba(230, 56, 181, 0.25);
}
...
.page-btn.active {
    ...
    color: #fff;
    box-shadow: 0 0 20px rgba(230, 56, 181, 0.3);
}
...
<div class="gallery-page">
    <!-- Hero Header Section -->
    <div class="gallery-hero py-8 md:py-12 px-4">
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
                
                <!-- Thumbnail -->
                <div class="hero-thumbnail flex-shrink-0 animate-fade-in-up">
                    <img src="./uploads/thumb_672c0ea1e9642.jpg"
                         alt="Fabienne"
                         class="w-28 h-28 md:w-36 md:h-36 rounded-xl object-cover shadow-2xl">
                </div>

                <!-- Content -->
                <div class="flex-1 text-center md:text-left space-y-4 animate-fade-in-up animation-delay-100">
                    <!-- Title -->
                    <h1 class="hero-title text-2xl md:text-3xl lg:text-4xl font-bold text-white tracking-tight">
                        Fabienne                    </h1>
                    ...
                    <div class="flex flex-wrap items-center justify-center md:justify-start gap-3">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="stat-card flex items-center gap-2 px-3 py-1.5 rounded-lg">
                                <svg class="w-4 h-4 text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <span class="text-sm font-medium text-gray-300">11</span>
                            </div>
                    ...
                    <!-- Action Buttons -->
                    <div class="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-2 animate-fade-in-up animation-delay-200">
                        <!-- Like Button -->
                                                    <div class="flex items-center gap-2 action-btn-modern">
                                                                    <span data-post="414" class="like-btn cursor-pointer like-heart">
                                        <i class="far fa-heart text-gray-400 text-lg"></i>
                                    </span>
                                    <span data-post="414" class="unlike-btn hidden cursor-pointer like-heart">
                                        <i class="fas fa-heart text-red-500 text-lg"></i>
                                    </span>
                                                                <span id="likes-414" class="text-sm font-medium text-gray-300">
                                    154                                </span>
                            </div>
                        
                        <!-- Download Button -->
                                                    <!-- Non-rank User: Button zeigen aber auf Rang hinweisen -->
                            <a href="/rank_upgrade" class="action-btn-modern primary group opacity-75">
                                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                </svg>
                                <span class="hidden sm:inline">ZIP Download</span>
                                <span class="px-2 py-0.5 bg-gray-600 text-gray-300 text-xs font-bold rounded-full">Nur mit Rang</span>
                            </a>
                                            </div>
                </div>
            </div>
    ...
    <!-- Filter Section -->
    <div class="sticky top-0 z-30 bg-gradient-to-b from-[#0a0a0f] via-[#0a0a0f] to-transparent pt-4 pb-6 px-4">
        <div class="max-w-7xl mx-auto">
            <div class="filter-scroll overflow-x-auto -mx-4 px-4">
                <div class="flex items-center gap-2 min-w-max">
                    <span class="text-sm text-gray-500 mr-2 hidden sm:inline">Sortieren:</span>
                    
                    <a href="gallery.php?post_id=414&sort=uploaded_at_desc#top" 
                       class="filter-pill flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium active">
                    ...
                    <a href="gallery.php?post_id=414&sort=images_first#top" 
                       class="filter-pill flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-gray-400">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        Bilder zuerst
                    ...
                    <a href="gallery.php?post_id=414&sort=videos_first#top" 
                       class="filter-pill flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-gray-400">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                        </svg>
    ...
    <div class="max-w-7xl mx-auto px-4 pb-8">
                    <div class="media-grid">
                                                        <div class="media-card" style="animation-delay: 0s;">
                        <a href="./uploads/posts/post_414/file_672c0ea43e2b3.mp4" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/default_video_thumbnail.jpg" 
                                     alt="Video" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.05s;">
                        <a href="./uploads/posts/post_414/file_672c0ea43aac1.mp4" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.1s;">
                        <a href="./uploads/posts/post_414/file_672c0ea43826e.mp4" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.15s;">
                        <a href="./uploads/posts/post_414/file_672c0ea43467e.mp4" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.2s;">
                        <a href="./uploads/posts/post_414/file_672c0ea43166c.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea43166c.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.25s;">
                        <a href="./uploads/posts/post_414/file_672c0ea42dbfd.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea42dbfd.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.3s;">
                        <a href="./uploads/posts/post_414/file_672c0ea42aec3.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea42aec3.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.35s;">
                        <a href="./uploads/posts/post_414/file_672c0ea426a84.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea426a84.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.4s;">
                        <a href="./uploads/posts/post_414/file_672c0ea421e77.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea421e77.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.45s;">
                        <a href="./uploads/posts/post_414/file_672c0ea41e595.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea41e595.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0s;">
                        <a href="./uploads/posts/post_414/file_672c0ea41b3c8.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea41b3c8.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.05s;">
                        <a href="./uploads/posts/post_414/file_672c0ea417121.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea417121.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.1s;">
                        <a href="./uploads/posts/post_414/file_672c0ea41317c.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea41317c.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.15s;">
                        <a href="./uploads/posts/post_414/file_672c0ea40f076.jpg" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea40f076.jpg" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.2s;">
                        <a href="./uploads/posts/post_414/file_672c0ea40b509.png" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
                            
                                                            <img data-src="./uploads/posts/post_414/file_672c0ea40b509.png" 
                                     alt="Bild" 
                                     class="lazy-img"
                                     loading="lazy"
                                     decoding="async">
                            ...
                            <div class="media-overlay"></div>
                                                        ...
                                                        <div class="media-card" style="animation-delay: 0.25s;">
                        <a href="./uploads/posts/post_414/file_672c0ea3db687.mp4" 
                           data-fancybox="gallery-414" 
                           data-caption="Fabienne">
        ...
        <!-- Pagination -->
                    <div class="pagination-modern mt-10 mb-6">
                
                <a href="gallery.php?post_id=414&page=1&sort=uploaded_at_desc#top" class="page-btn active">1</a><a href="gallery.php?post_id=414&page=2&sort=uploaded_at_desc#top" class="page-btn ">2</a>
                                    <a href="gallery.php?post_id=414&page=2&sort=uploaded_at_desc#top" 
                       class="page-btn nav">
    ...
    <!-- Progress Modal -->
    <div id="progressModal" class="fixed inset-0 bg-black/80 backdrop-blur-md hidden flex items-center justify-center z-50 p-4">
        <div class="bg-[#12121a] p-6 md:p-8 rounded-2xl shadow-2xl w-full max-w-sm border border-white/10">
            <div class="flex flex-col items-center justify-center space-y-6">
                <div class="relative w-20 h-20">
                    ...
                    <div class="absolute inset-6 bg-gradient-to-br from-pink-500 to-indigo-500 rounded-full animate-pulse"></div>
                </div>
                
                <div class="text-center space-y-2">
                    <h3 class="text-xl font-bold text-white">ZIP-Download</h3>
                    <p id="statusText" class="text-gray-400">Bereite Download vor...</p>
                </div>
                
                <div class="bg-white/5 border border-white/10 rounded-xl p-4 w-full">
                    <p id="estimatedTime" class="text-sm text-gray-400 text-center">
                        Bitte warten...
                    </p>
                </div>
            </div>
    ...
    <!-- Purchase Modal -->
    <div id="purchaseConfirmModal" class="fixed inset-0 bg-black/80 backdrop-blur-md hidden flex items-center justify-center z-50 p-4">
        <div class="bg-[#12121a] p-6 md:p-8 rounded-2xl shadow-2xl w-full max-w-md border border-white/10">
            <div class="flex flex-col items-center justify-center space-y-5">
                <div class="w-16 h-16 bg-gradient-to-br from-pink-500/20 to-indigo-500/20 rounded-2xl flex items-center justify-center">
                ...
                <div class="text-center space-y-2">
                    <h3 class="text-2xl font-bold text-white">ZIP Download freischalten</h3>
                    <p class="text-gray-500 text-sm">Einmalzahlung • Für alle Galerien</p>
                </div>
                
                <div class="w-full bg-white/5 rounded-xl p-4 space-y-3">
                    <div class="text-sm font-semibold text-white mb-2">Das bekommst du:</div>
                    <div class="flex items-center gap-3 text-sm text-gray-300">
                        <span class="text-green-400">✓</span>
                        <span>Alle Medien als ZIP herunterladen</span>
                    </div>
                    <div class="flex items-center gap-3 text-sm text-gray-300">
                        <span class="text-green-400">✓</span>
                        <span>Funktioniert für <strong class="text-white">alle</strong> Galerien</span>
                    </div>
                    <div class="flex items-center gap-3 text-sm text-gray-300">
                        <span class="text-green-400">✓</span>
                        <span>Dauerhaft freigeschaltet</span>
                    </div>
                </div>
                
                <div class="text-center">
                    <span class="text-4xl font-bold bg-gradient-to-r from-pink-400 to-indigo-400 bg-clip-text text-transparent">4,99€</span>
                    <span class="text-gray-500 text-sm ml-2">einmalig</span>
                </div>
                
                <div class="flex gap-3 w-full">
                    <button onclick="closePurchaseModal()" class="flex-1 px-4 py-3 bg-white/5 hover:bg-white/10 text-white font-medium rounded-xl transition-all">
                        Abbrechen
                    </button>
                    <button onclick="confirmPurchase()" class="flex-1 px-4 py-3 bg-gradient-to-r from-pink-500 to-indigo-500 hover:from-pink-600 hover:to-indigo-600 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-pink-500/25">
                        Jetzt kaufen
                    </button>
                </div>
            </div>
...
<script>
    ...
    <script src="./assets/js/main.js?v=1770682271"></script>
...
<script>
document.addEventListener('DOMContentLoaded', function() {
    // Optimiertes Lazy Loading mit IntersectionObserver
    ...
    const imageObserver = new IntersectionObserver((entries, observer) => {
        ...
        rootMargin: '200px 0px', // Lädt Bilder 200px bevor sie sichtbar werden
        threshold: 0.01
    });
    ...
    Fancybox.bind('[data-fancybox]', {
        ...
        on: {
            close: (fancybox) => {
                if (fancybox.items && fancybox.items.length > 0) {
...
function closePurchaseModal() {
    document.getElementById('purchaseConfirmModal').classList.add('hidden');
}

function purchaseDownloadAccess() {
    document.getElementById('purchaseConfirmModal').classList.remove('hidden');
}

async function startDownload(galleryId) {
    try {
        const checkResponse = await fetch(`download_gallery_direct.php?gallery_id=${galleryId}&check=1`);
        ...
        statusText.textContent = 'Starte Download...';
        estimatedTime.innerHTML = 'Die ZIP-Datei wird je