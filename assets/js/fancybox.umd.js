!function(t, e) {
    ...
    class k extends g {
        ...
        onClick(t)
        {
            ...
            h ? (this.clicks++, 1 == this.clicks && (this.clickTimer = setTimeout((() => {
                1 === this.clicks ? (this.emit("click", t), !t.defaultPrevented && c && l(c)) : (this.emit("dblClick", t), t.defaultPrevented || l(h)),
                this.clicks = 0,
        ...
        onPointerDown(t, e, i)
        {
            ...
            if (!i.length) {
                ...
                if (["A", "TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].includes(e.nodeName) || e.closest("[contenteditable]") || e.closest("[data-selectable]") || e.closest("[data-draggable]") || e.closest("[data-panzoom-change]") || e.closest("[data-panzoom-action]"))
                    return !1;
        ...
        onPointerMove(t, i, s)
        {
            ...
            if (b && !this.lockedAxis)
                if ("xy" === b || "y" === b || "touchmove" === t.type) {
                    ...
                    this.lockedAxis = b;
            if (n(t.target, this.content) && (b = "x", this.dragOffset.y = 0), b && "xy" !== b && this.lockedAxis !== b && e(this.targetScale) === e(this.minScale))
                return;
        ...
        onWheel(t)
        {
            ...
            if (this.emit("wheel", t, i), this.panMode === O)
                return;
        ...
        updateControls()
        {
            ...
            for (const t of i.querySelectorAll('[data-panzoom-action="zoomOut"]'))
                p ? (t.removeAttribute("disabled"), t.removeAttribute("tabindex")) : (t.setAttribute("disabled", ""), t.setAttribute("tabindex", "-1"));
        ...
        {
            if (this.pmme = t, this.panMode !== O || !t)
                return;
        ...
        zoomTo(t=1, {friction: e="auto", originX: i=0, originY: n=0, event: s}={})
        {
            ...
            "number" == typeof t ? a = t / o : ("next" === t && (r - c < .2 && (c = r), t = o < r - 1e-5 ? "full" : o < l - 1e-5 ? "max" : "fit"), a = "full" === t ? r / o || 1 : "cover" === t ? c / o || 1 : "max" === t ? l / o || 1 : 1 / o || 1),
        ...
        reset(t)
        {
            if (this.state !== b.Init && this.state !== b.Destroy) {
                ...
                this.isResting || (this.friction = void 0 === t ? this.option("friction") : t, this.state = b.Panning, this.requestTick())
            }
        }
        destroy()
        {
    ...
    class G extends g {
        ...
        createPages()
        {
            ...
            for (const e of this.slides)
                (!t.length || o + e.dim > i || a === n) && (t.push(B()), s = t.length - 1, o = 0, a = 0),
                t[s].slides.push(e),
                o += e.dim + e.gap,
                a++;
            return t
        ...
        repositionSlides()
        {
            ...
            n && i && (m *= -1);
            for (const i of h)
                i.el ? ("top" === t ? (i.el.style.right = "", i.el.style.left = "") : i.el.style.top = "", i.index !== u ? i.el.style[t] = 0 === p ? "" : `${e(p, 1e3)}px` : i.el.style[t] = "", f += i.dim + i.gap, u++) : p += i.dim + i.gap;
            if (s && f && o) {
        ...
        removeSlideEl(t, e=!1)
        {
            ...
            if (E(i, this.cn("isSelected")), t.isDom && !e)
                return i.removeAttribute("aria-hidden"), i.removeAttribute("data-index"), E(i, this.cn("isSelected")), void (i.style.left = "");
        ...
        flipInfiniteTrack()
        {
            ...
            let s = t.current[e],
                ...
                r = .5 * i,
                l = n;
            this.isRTL && this.isHorizontal ? (s < -r && (a = -1, s += l), s > l - r && (a = 1, s -= l)) : (s > r && (a = 1, s -= l), s < -l + r && (a = -1, s += l)),
        ...
        lazyLoadSlide(t)
        {
            ...
            const r = (t, i, n) => {
                n && (n.remove(), n = null),
                i.complete && (i.classList.add(o), setTimeout((() => {
        ...
        updateMetrics()
        {
            ...
            t && l === this.pages.length && Math.abs(c - h) > .5 && (t.target[this.axis] = -1 * this.pages[this.page].pos, t.current[this.axis] = -1 * this.pages[this.page].pos, t.stop()),
            this.manageSlideVisiblity(),
            this.emit("refresh")
        }
        getProgress(t, i=!1)
    ...
    class ot extends _ {
        ...
        static startFromUrl()
        {
            if (ot.hasSilentClose = !1, _t.getInstance() || !1 === _t.defaults.Hash)
                return;
    ...
    class rt extends _ {
        ...
        process(t, e)
        {
            return new Promise(((i, n) => {
                ...
                c && S(c) || (c = document.createElement("img"), c instanceof HTMLImageElement && (c.src = e || "", c.alt = (null === (o = t.caption) || void 0 === o ? void 0 : o.replace(/<[^>]+>/gi, "").substring(0, 1e3)) || `Image ${t.index + 1} of ${null === (a = r.carousel) || void 0 === a ? void 0 : a.pages.length}`, c.draggable = !1, t.srcset && c.setAttribute("srcset", t.srcset)), t.sizes && c.setAttribute("sizes", t.sizes)),
        ...
        zoomIn(t)
        {
            return new Promise(((e, i) => {
                ...
                const {x: c, y: h, scale: d, opacity: u} = l,
                    ...
                    f = t => {
                        E(s, "is-zooming-in"),
                        t.scale < .99 || t.scale > 1.01 || (a.style.opacity = "", t.off("endAnimation", f), t.off("touchStart", f), t.off("afterTransform", p), e(t))
                    };
                o.on("endAnimation", f),
                o.on("touchStart", f),
    ...
    class dt extends _ {
        ...
        setIframeContent(t)
        {
            ...
            if (i.classList.add("is-loading"), "iframe" !== t.type || !1 === o)
                return s.setAttribute("src", t.src + ""), this.resizeIframe(t), void n.setContent(t, s);
            n.showLoading(t),
            s.onload = () => {
                if (!s.src.length)
                    return;
    ...
    let yt = class  extends _{
        ...
        onTransformM()
        {
            ...
            i && (i.style.setProperty("--left", h + ""), i.style.setProperty("--width", l + h + s + o * c + "")),
        ...
        centerModern(t)
        {
            ...
            let l = 100;
            void 0 === t && (t = .2, i.inTransition.size > 0 && (t = .12), Math.abs(-1 * s.current.e - r) > s.containerRect.width && (t = .5, l = 0)),
    ...
    class _t extends g {
        ...
        init()
        {
            if (this.state === it.Destroy)
                return;
            this.state = it.Init,
            this.attachPlugins(Object.assign(Object.assign({}, _t.Plugins), this.userPlugins)),
            this.emit("init"),
            !0 === this.option("hideScrollbar") && (() => {
                if (!K)
                    return;
                const t = document.body;
                if (t.classList.contains(At))
                    return;
        ...
        manageCaption(t)
        {
            ...
            if (this.caption && this.stop(this.caption), r && this.caption && (this.caption.remove(), this.caption = null), a && !this.caption)
                for (const t of (null === (e = this.carousel) || void 0 === e ? void 0 : e.slides) || [])
                    t.captionEl && (t.captionEl.remove(), t.captionEl = void 0, E(t.el, s), null === (i = t.el) || void 0 === i || i.removeAttribute("aria-labelledby"));
        ...
        focus(t)
        {
            ...
            let h = null;
            t ? (!n || l.indexOf(n) < 0) && (h = c || s, l.length && (i === jt ? h = l[0] : this.lastFocus !== s && i !== Ft || (h = l[l.length - 1]))) : h = o && "image" === o.type ? s : c || s,
            h && tt(h),
        ...
        {
            this.clearIdle(),
            this.idle && !this.isClosing() && (this.idle = !1, E(this.container, "is-idle"), this.emit("endIdle"))
        }
        resetIdle()
        {
            this.endIdle(),
        ...
        proceedClose(t, e)
        {
            ...
            this.emit("close", t),
            this.state !== it.CustomClosing ? (void 0 === e && a && (e = this.optionFor(a, "hideClass")), e && a ? (this.animate(a.contentEl, e, (() => {
        ...
        static bind(t, e, i)
        {
            ...
            let n,
                s = "",
                o = {};
            if (void 0 === t ? n = document.body : "string" == typeof t ? (n = document.body, s = t, "object" == typeof e && (o = e || {})) : (n = t, "string" == typeof e && (s = e), "object" == typeof i && (o = i || {})), !n || !S(n))
                return;
            s = s || "[data-fancybox]";
        ...
        static unbind(t, e)
        {
            let i,
                n = "";
            if ("string" == typeof t ? (i = document.body, n = t) : (i = t, "string" == typeof e && (n = e)), !i)
                return;
            const s = _t.openers.get(i);
            s && n && s.delete(n),
            n && s || (_t.openers.delete(i), i.removeEventListener("click", _t.fromEvent))
        }
        static destroy()
        {
            let t;
            for (; t = _t.getInstance();)
                t.destroy();
        ...
        static fromSelector(t, e)
        {
            let i = null,
                n = "";
            if ("string" == typeof t ? (i = document.body, n = t) : t instanceof HTMLElement && "string" == typeof e && (i = t, n = e), !i || !n)
                return !1;
            const s = _t.openers.get(i);
            if (!s)
                return !1;
